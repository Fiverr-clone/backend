...
router.get('/online-courses/learn-programming', subCategoryController.onlineCoursesLearnProgramming);
router.get('/online-courses/learn-digital-marketing', subCategoryController.onlineCoursesLearnDigitalMarketing);
router.get('/online-courses/learn-english', subCategoryController.onlineCoursesLearnEnglish);
router.get('/online-courses/learn-french', subCategoryController.onlineCoursesLearnFrench);
//Digital marketing

...
router.get(
	...
	subCategoryController.digitalMarketingWebsiteAds
);
router.get(
	"/digital-marketing/content-marketing",
	subCategoryController.digitalMarketingContentMarketing
);
router.get(
	"/digital-marketing/instagram-marketing",
	subCategoryController.digitalMarketingInstagramMarketing
);
router.get(
	"/digital-marketing/facebook-marketing",
	subCategoryController.digitalMarketingFacebookMarketing
);
//Writing & translating
router.get(
	"/writing-translation/translation-services",
	subCategoryController.writingTranslationTranslationServices
);
router.get(
	"/writing-translation/summarising-services",
	subCategoryController.writingTranslationSummarisingServices
);
router.get(
	"/writing-translation/sales-copy",
	subCategoryController.writingTranslationSalesCopy
);
router.get(
	"/writing-translation/scriptwriting",
	subCategoryController.writingTranslationScriptwriting
);
//Design
router.get(
	"/design/book-cover-design",
	subCategoryController.designBookCoverDesign
);
router.get(
	"/design/business-card-design",
	subCategoryController.designBusinessCardDesign
);
router.get(
	"/design/presentation-design",
	subCategoryController.designPresentationDesign
);
router.get(
	"/design/photo-editing-services",
	subCategoryController.designPhotoEditingServices
);
//PROGRAMMING & DEVELOPMENT
router.get(
	"/programming-development/htmlcss--programming",
	subCategoryController.programmingDevelopmentHtmlCssProgramming
);
router.get(
	"/programming-development/java-dot-net-programming",
	subCategoryController.programmingDevelopmentJavaDotNetProgramming
);
router.get(
	"/programming-development/php-programming",
	subCategoryController.programmingDevelopmentPhpProgramming
);
router.get(
	"/programming-development/python-programming",
	subCategoryController.programmingDevelopmentPythonProgramming
);
router.get(
	"/programming-development/mobile-app-programming",
	subCategoryController.programmingDevelopmentMobileAppProgramming
);
router.get(
